  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap justify-center gap-8 p-8 mt-20">
        ...
        {/* Percentage of Participants Who Paid */}
        <div className="w-full md:w-1/2 lg:w-1/3 bg-slate-50 rounded-lg shadow-lg p-6">
          <h3 className="text-lg font-medium mb-4">Percentage of Participants Who Paid</h3>
        ...
        {/* Percentage of Chit Amount Paid */}
        <div className="w-full md:w-1/2 lg:w-1/3 bg-slate-50 rounded-lg shadow-lg p-6">
          <h3 className="text-lg font-medium mb-4">Percentage of Chit Amount Paid</h3>
          <PieChart width={200} height={200}>
            <Pie
              data={[
                { name: "Paid", value: data.chitAmountPaid },
                { name: "Unpaid", value: data.chitAmount - data.chitAmountPaid },
              ]}
              dataKey="value"
              nameKey="name"
              cx="50%"
            ...
            >
              ...
              {data.chitAmount - data.chitAmountPaid > 0 && (
                <Cell key="unpaid" fill={COLORS[1]} />
              )}
            </Pie>
            <Tooltip />
          </PieChart>
