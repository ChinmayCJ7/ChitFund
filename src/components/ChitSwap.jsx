...
const ChitSwap = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Navbar />
      <main className="mx-auto w-2/3 mt-24 flex-grow">
        <div className="my-4">
          ...
          <div className="border p-4">
            <div className="mb-4">
              ...
              <p className="text-gray-500">
                Prize: {chitDetails.prize} | Amount: {chitDetails.amount} |
                Installment: {chitDetails.installment} | Participants: {chitDetails.participants}
              </p>
            </div>
            {swapRequest && (
              <div className="border p-4 mb-4">
                <p className="text-lg font-semibold">{swapRequest.user} has requested a swap</p>
                <p className="text-gray-500 whitespace-pre-line">{swapRequest.message}</p>
              ...
              <div className="border p-4">
                <p className="text-lg font-semibold">
                  {requestStatus === 'accepted'
                    ...
                    : 'You have rejected the swap request.'}
                </p>
              </div>
            )}
          </div>
